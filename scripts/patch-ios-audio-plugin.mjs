...
const pluginBaseName = 'BestTakeAudioPlugin'
...
const moduleQualified = `${moduleName}.${pluginBaseName}`
...
const requiredPluginClasses = [moduleQualified]
...
const stripped = existing.filter(
  (entry) => entry !== pluginBaseName && entry !== moduleQualified,
)
