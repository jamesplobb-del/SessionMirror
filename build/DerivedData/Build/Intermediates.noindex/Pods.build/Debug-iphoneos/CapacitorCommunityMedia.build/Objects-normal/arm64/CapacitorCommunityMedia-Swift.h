...
#ifndef CAPACITORCOMMUNITYMEDIA_SWIFT_H
#define CAPACITORCOMMUNITYMEDIA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CapacitorCommunityMedia",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface MediaPlugin : CAPPlugin
